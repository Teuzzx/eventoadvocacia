...
const WHATSAPP_URL = 'https://wa.me/558999384039'
    ...
    <tr>
      <td align="center">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;background-color:#ffffff;border-radius:14px;overflow:hidden;box-shadow:0 6px 24px rgba(7,21,39,0.10);">
          ...
          <!-- Cabeçalho -->
          <tr>
            <td style="background:linear-gradient(135deg,#0b1f3a 0%,#071527 100%);padding:32px 24px 26px;text-align:center;">
              <img src="${LOGO_URL}" alt="AMACENTROSUL" width="150" style="max-width:150px;height:auto;border:0;display:inline-block;">
              <h1 style="margin:16px 0 4px;font-family:Georgia,'Times New Roman',serif;font-size:24px;color:#c9a227;line-height:1.3;">${EVENTO_INFO.titulo}</h1>
          ...
          <!-- Rodapé -->
          <tr>
            <td style="background:#071527;padding:24px 28px;text-align:center;">
              <p style="margin:0 0 8px;font-family:Arial,Helvetica,sans-serif;font-size:13px;color:#c9a227;font-weight:bold;">Associação das Mulheres Advogadas do Centro Sul do Piauí</p>
              ...
              <a href="${INSTAGRAM_URL}" style="display:inline-block;margin:0 6px;padding:8px 16px;background:#0b1f3a;border:1px solid #c9a227;border-radius:20px;font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#c9a227;text-decoration:none;">📸 @amacentrosul</a>
              <a href="${WHATSAPP_URL}" style="display:inline-block;margin:0 6px;padding:8px 16px;background:#0b1f3a;border:1px solid #c9a227;border-radius:20px;font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#c9a227;text-decoration:none;">💬 Fale conosco</a>
            </td>
          </tr>
...
export function montarEmailConfirmacao(dados: {
  ...
  const conteudo = `
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
      <tr>
        <td align="center">
          <span style="display:inline-block;padding:8px 20px;background:rgba(201,162,39,0.12);border:1px solid #c9a227;border-radius:24px;font-size:13px;font-weight:bold;color:#8a6d14;letter-spacing:0.6px;">✅ INSCRIÇÃO CONFIRMADA</span>
        </td>
      </tr>
    </table>

    <p style="margin:0 0 16px;">Olá, <strong style="color:#0b1f3a;">${escapeHtml(dados.nome)}</strong>!</p>
    ...
    <!-- Senha de acesso -->
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#fdf8ea;border:2px dashed #c9a227;border-radius:12px;margin-bottom:24px;">
      <tr>
        <td style="padding:20px;text-align:center;">
          <p style="margin:0 0 6px;font-size:12px;color:#8a6d14;letter-spacing:1px;font-weight:bold;">🔑 SUA SENHA DE ACESSO AO EVENTO</p>
          <p style="margin:0 0 6px;font-family:Consolas,'Courier New',monospace;font-size:34px;font-weight:bold;color:#0b1f3a;letter-spacing:8px;">${escapeHtml(dados.codigo_acesso)}</p>
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f7f7f5;border-radius:10px;margin-bottom:18px;">
      <tr><td style="padding:18px 20px 6px;font-size:13px;font-weight:bold;color:#0b1f3a;letter-spacing:0.5px;">📋 DETALHES DO EVENTO</td></tr>
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f7f7f5;border-radius:10px;margin-bottom:24px;">
      <tr><td style="padding:18px 20px 6px;font-size:13px;font-weight:bold;color:#0b1f3a;letter-spacing:0.5px;">💰 INFORMAÇÕES DE PAGAMENTO</td></tr>
    ...
    <p style="margin:0 0 24px;font-weight:bold;color:#0b1f3a;">Agradecemos sua participação! 🤝</p>
  `
...
export function montarEmailCertificado(dados: {
  ...
  const conteudo = `
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
      <tr>
        <td align="center">
          <span style="display:inline-block;padding:8px 20px;background:rgba(201,162,39,0.12);border:1px solid #c9a227;border-radius:24px;font-size:13px;font-weight:bold;color:#8a6d14;letter-spacing:0.6px;">🎓 CERTIFICADO DISPONÍVEL</span>
        </td>
      </tr>
    </table>
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f7f7f5;border-radius:10px;margin-bottom:24px;">
      <tr><td style="padding:18px 20px 6px;font-size:13px;font-weight:bold;color:#0b1f3a;letter-spacing:0.5px;">📜 SEU CERTIFICADO</td></tr>
    ...
    <p style="margin:0 0 24px;font-weight:bold;color:#0b1f3a;">Continue inspirando, empreendendo e incluindo! ✨</p>
  `
